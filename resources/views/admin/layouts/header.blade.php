<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        {{--                                    <li>--}}
        {{--                                        <img src="" alt="Avatar">--}}
        {{--                                        <img src="{{ asset('dist/admin/assets/images/xs/avatar5.jpg') }}" alt="">--}}
        ...
        <li><a href="{{ route('admin.setting') }}" class="js-right-sidebar" title="Setting"><i
                    class="zmdi zmdi-settings zmdi-hc-spin"></i></a></li>
        <li>
            <a href="{{ route('logout') }}" id="logout_button" class="mega-menu btn-raised waves-effect event_button"
               data-type="logout" title="Sign Out" onclick="event.preventDefault(); "><i
        ...
        {{--            <a href="sign-in.html" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i></a></li>--}}
    </ul>
</div>
